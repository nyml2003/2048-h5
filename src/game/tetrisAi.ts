import { AI_ACTION_ORDER, BOARD_SIZE } from "@/game/constants";
import { applyAction, canMove } from "@/game/tetrisEngine";
import type { BoardCell, BoardMatrix, ControlAction, GameState } from "@/game/types";
